        ...
        <form class="form-horizontal">
            <fieldset class="fieldset">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10 col-sm-9 col-xs-12">
                        <input type="text" class="form-control" v-model="user.customer_name">
                    </div>
                </div>
            </fieldset>
            <fieldset class="fieldset">
                <h3 class="fieldset-title">Info</h3>
                <div class="form-group">
                    <label class="col-md-2  col-sm-3 col-xs-12 control-label">Email</label>
                    <div class="col-md-10 col-sm-9 col-xs-12">
                        <input type="email" class="form-control" v-model="user.customer_email">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10 col-sm-9 col-xs-12">
                        <input type="text" class="form-control" v-model="user.customer_phone">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10 col-sm-9 col-xs-12">
                        <input type="text" class="form-control" v-model="user.customer_address">
            ...
            <div class="form-group">
                <div class="col-md-10 col-sm-9 col-xs-12 col-md-push-2 col-sm-push-3 col-xs-push-0">
                    <input class="btn btn-primary" type="button" value="Update Profile" @click="update">
                </div>
            </div>
        </form>
    </div>
...
export default {
    ...
    methods: {
        update() {
            CustomerRepository.update(this.user, this.$store.state.customer.access_token).then(
                response => {
                    response
